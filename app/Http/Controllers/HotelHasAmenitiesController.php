...
use App\Hotel;
use App\Amenitie;
use App\HotelHasAmenities;
use Validator;
use Response;
use Illuminate\Support\Facedes\Input;
use App\http\Requests;

class HotelHasAmenitiesController extends Controller
{
    public function index(Hotel $hotel)
    {
        return view('admin.hotelamenities.index')->with('hotel',$hotel)->with('amenities',HotelHasAmenities::all()->where('hotel_id',$hotel->id))
    ...
    public function addhotelamenitie(Request $request){
        ...
        return Response::json(array('errors'=> $validator->getMessageBag()->toarray()));
            ...
            $amenitie=HotelHasAmenities::create([
    ...
    public function deletehotelamenitie(request $request){
        $del_id=$request->id;
        $amenitie = HotelHasAmenities::find ($request->id)->delete();
