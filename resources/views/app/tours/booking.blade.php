...
<div class="page-title-container">
    <div class="container">
        <div class="page-title pull-left">
            <h2 class="entry-title">Tour Booking - {{ $tour->name }}</h2>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div id="main" class="col-sms-6 col-sm-8 col-md-9">
                <div class="booking-section travelo-box">
                    ...
                    <form class="booking-form" method="post" action="{{ route('booktour') }}">
                        {{ csrf_field() }}
                        <div class="person-information">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 col-md-5">
                                    ...
                                    <div class="datepicker-wrap">
                                        <input type="text" name="date" data-date-format="Y-m-d" class="input-text full-width" value="{{old('date')}}"  class="form-control date-picker">
                                    </div>
                                </div>
                                <div class="col-sm-3 col-md-2">
                                    <label>Adults</label>
                                    <input type="text" name="adults" class="input-text full-width" value="{{old('adults')}}" placeholder="" />
                                </div>
                                <div class="col-sm-3 col-md-2">
                                    <label>Kids</label>
                                    <input type="text" name="kids" class="input-text full-width" value="{{old('kids')}}" placeholder="" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-6 col-md-5">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 col-md-5">
                                    ...
                                    <input type="text" name="personal_address" class="input-text full-width" value="{{old('personal_address')}}" placeholder="" />
                                </div>
                                <div class="col-sm-6 col-md-5">
                                    <label>Passport id</label>
                                    <input type="text" name="passport" class="input-text full-width" value="{{old('passport')}}" placeholder="" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-6 col-md-5">
                                ...
                                <div class="col-sm-6 col-md-5">
                                    ...
                                    <input type="text" name="r_email_address" class="input-text full-width" value="{{old('r_email_address')}}" placeholder="" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-6 col-md-5">
                            ...
                            <div class="form-group">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="is_receive_promotion" value="1"> I want to receive <span class="skin-color">Travelo</span> promotional offers in the future
                                    </label>
                                </div>
                            </div>
                        </div>
                ...
                <div class="booking-details travelo-box">
                    ...
                    <article class="tour-detail">
                        <figure class="clearfix">
                            <a title="" href="tour-detailed1.html" class="middle-block"><img class="middle-item" alt="" src="http://placehold.it/124x78"></a>
                            <div class="travel-title">
                                <h5 class="box-title">{{ $tour->name }}<small>{{ $tour->duration }} Tour</small></h5>
                            </div>
                        </figure>
                        <div class="details">
                            <div class="icon-box style11 full-width">
                                ...
                                <dl class="details">
                                    ...
                                    <dd>{{ $tour->days }} days {{ $tour->nights }} nights</dd>
                                </dl>
                            </div>
                            <div class="icon-box style11 full-width">
                                <div class="icon-wrapper">
                                ...
                                <dl class="details">
                                    <dt class="skin-color">Country</dt>
                                    <dd>{{ $tour->country->name }}</dd>
                                </dl>
                            </div>
                        </div>
                    </article>
                    ...
                    <dl class="other-details">
                        ...
                        <dt class="total-price">Total Price</dt><dd class="total-price-value">${{ $tour->amount }}</dd>
                    </dl>
                </div>
