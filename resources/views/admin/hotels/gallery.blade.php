                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between g-3">
                        ...
                        <div class="nk-block-head-content">
                            <h2 class="nk-block-title page-title">Images for {{$hotel->name}}</h2>
                ...
                <div class="nk-block">
                    <ul class="nk-block-tools g-3">
                        <li class="nk-block-tools-opt">
                            <a href="{{ route('hotelamenities.index',$hotel->id) }}" class="btn btn-primary">
                ...
                <div class="modal-body modal-body-md">
                    <div class="nk-upload-form">
                        ...
                        <form id="dropzoneForm" class="dropzone small bg-lighter" action="{{ route('dropzone.upload') }}">
                            ...
                            <input type="hidden" name="id_type" value="{{ $hotel->id }}">
