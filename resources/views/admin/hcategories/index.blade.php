                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between g-3">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Hotel Categories</h3>
                                            <div class="nk-block-des text-soft">
                                                <p>You have total {{ $categories->count() }} hotel categories.</p>
                                            </div>
                                        ...
                                        <div class="nk-block-head-content">
                                            <ul class="nk-block-tools g-3">
                                                <li>
                                                    <div class="drodown">
                                                        <a href="{{ route('hotelcategories.create') }}" class=" btn btn-icon btn-primary"><em class="icon ni ni-plus"></em></a>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div><!-- .nk-block-head-content -->
                                                                    ...
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                                                            <ul class="link-list-plain">
                                                                                <li><a href="{{ route('hotelcategories.edit',$category->id)}}">Edit</a></li>
...
@section('script')
    <script>
        function handleDelete(id){
            ...
            form.action='/hotelcategories/'+id
