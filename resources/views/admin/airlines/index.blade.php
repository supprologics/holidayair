                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between g-3">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Airlines</h3>
                                            <div class="nk-block-des text-soft">
                                                <p>You have total {{ $airlines->count() }} airlines.</p>
                                            </div>
                                        ...
                                        <div class="nk-block-head-content">
                                            <ul class="nk-block-tools g-3">
                                                <li>
                                                    <div class="drodown">
                                                        <a href="{{ route('airlines.create') }}" class=" btn btn-icon btn-primary"><em class="icon ni ni-plus"></em></a>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div><!-- .nk-block-head-content -->
                                            ...
                                            <div class="card-inner">
                                                <div class="card-title-group">
                                                    <div class="card-title">
                                                        <h5 class="title">All Airlines.</h5>
                                                    </div>
                                                    ...
                                                    <tbody>
                                                        @foreach ($airlines as $airline)
                                                            <tr class="tb-tnx-item">
                                                                <td class="tb-tnx-id">
                                                                    <a href="#"><span>{{ $airline->id }}</span></a>
                                                                </td>
                                                                <td class="tb-tnx-info">
                                                                    <div class="tb-tnx-desc">
                                                                        <span class="title">{{ $airline->code }}</span>
                                                                    </div>
                                                                </td>
                                                                <td class="tb-tnx-info">
                                                                    <div class="tb-tnx-desc">
                                                                        <span class="title">{{ $airline->name }}</span>
                                                                    </div>
                                                                </td>
                                                                <td class="tb-tnx-info">
                                                                    <div class="tb-tnx-desc">
                                                                        <span class="title">{{ $airline->country->name }}</span>
                                                                    </div>
                                                                </td>
                                                                <td class="tb-tnx-info">
                                                                    <img src="{{ asset('storage/'.$airline->logo) }}" style="width:100px">
                                                                    ...
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                                                            <ul class="link-list-plain">
                                                                                <li><a href="{{ route('airlines.edit',$airline->id)}}">Edit</a></li>
                                                                                <li><a role="button" onclick="handleDelete({{$airline->id}})">Remove</a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                </td>
