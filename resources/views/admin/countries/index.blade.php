                                    ...
                                    <div class="nk-block-between g-3">
                                        <div class="nk-block-head-content">
                                            ...
                                            <div class="nk-block-des text-soft">
                                                <p>You have total {{ $countries->count() }} countries.</p>
                                            </div>
                                        ...
                                        <div class="nk-block-head-content">
                                            <ul class="nk-block-tools g-3">
                                                <li>
                                                    <div class="drodown">
                                                        <a href="{{ route('countries.create') }}" class=" btn btn-icon btn-primary"><em class="icon ni ni-plus"></em></a>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div><!-- .nk-block-head-content -->
                                            ...
                                            <div class="card-inner">
                                                <div class="card-title-group">
                                                    <div class="card-title">
                                                        <h5 class="title">All Countries</h5>
                                                    </div>
                                                    ...
                                                    <tbody>
                                                        @foreach ($countries as $country)
                                                            <tr class="tb-tnx-item">
                                                                ...
                                                                <td class="tb-tnx-info">
                                                                    <div class="tb-tnx-desc">
                                                                        <span class="title">{{ $country->areas->count() }}</span>
                                                                    </div>
                                                                </td>
                                                                <td class="tb-tnx-info">
                                                                    <div class="tb-tnx-date">
                                                                        <span class="date">{{ $country->created_at }}</span>
                                                                        <span class="date">{{ $country->updated_at }}</span>
                                                                    </div>
                                                                </td>
                                                                    ...
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                                                            <ul class="link-list-plain">
                                                                                ...
                                                                                <li><a role="button" onclick="handleDelete({{$country->id}})">Remove</a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                </td>
