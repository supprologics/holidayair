        ...
        <div class="nk-content-inner">
            ...
            <div class="nk-content-description">
                ...
                @include('partials.header',[
                    'header'=>'Itineraries for '.$tour->name,
                    'icon'=>'ni-plus',
                    'button'=>'Add New Itinerary',
                    'button_id'=>'add-itinerary',
                ])
                                ...
                                <table class="table table-tranx" id="table">
                                    ...
                                    <tbody>
                                        @if ($itineraries->count()==0)
                                            ...
                                            <tr class="tb-tnx-item itinerary0 center">
                                        ...
                                        @foreach ($itineraries as $itinerary)
                                            <tr class="tb-tnx-item itinerary{{$itinerary->id}}">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                                            <ul class="link-list-plain">
                                                                <li><a class="show-modal " data-id="{{ $itinerary->id}}" data-title="{{ $itinerary->title}}" data-description="{{ $itinerary->description}}" >View</a></li>
                                                                <li><a class="edit-modal " data-id="{{ $itinerary->id}}" data-title="{{ $itinerary->title}}" data-description="{{ $itinerary->description}}" >Edit</a></li>
                                                                <li><a class="delete-modal " data-id="{{ $itinerary->id}}" data-title="{{ $itinerary->title}}" data-description="{{ $itinerary->description}}" >Remove</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <div class="modal-body">
                                                <form action="" method="POST" class="form-horizontal " role="modal">
                                                    ...
                                                    <div class="delete text-center">
                                                        ...
                                                        <h4 class="nk-modal-title">Delete Itinerary!</h4>
                                                        <div class="nk-modal-text">
                                                            <div class="caption-text">Are you sure, you want to <strong>delete</strong> this itinerary ?</div>
                                                        ...
                                                        <div class="nk-modal-action">
                                                            ...
                                                            <button type="button" id="del-itinerary" class="btn-lg btn-mw btn-danger">Yes, Delete</button>
                                                        </div>
                                                    </div>
                ...
                <div class="nk-block">
                    <ul class="nk-block-tools g-3">
                        ...
                        <li class="nk-block-tools-opt">
                            <a href="{{ route('setinculdes',$tour->id) }}" class="btn btn-primary">
...
@section('script')
    ...
    <script>
        $(document).on('click','.create-modal',function(){
            ...
            $('.modal-title').text('Add Itinerary');
            ...
            $.ajax({
                ...
                success:function(data){
                    if((data.errors)){
                        ...
                        $('.error').remove();
                        $('.itinerary0').remove();
                        $('#table').append("<tr class='tb-tnx-item itinerary" + data.itinerary.id + "'>"+
                        "<td class='tb-tnx-info'>"+
                            "<div class='tb-tnx-info'>"+
                                "<span class='title'>"+ data.itinerary.title + "</span>"+
                            "</div>"+
                        "</td>"+
                        "<td class='tb-tnx-action'>"+
                            "<div class='dropdown'>"+
                                ...
                                "<div class='dropdown-menu dropdown-menu-right dropdown-menu-xs'>"+
                                    "<ul class='link-list-plain'>"+
                                        "<li><a class='show-modal ' data-id='"+ data.itinerary.id + "' data-title='" + data.itinerary.title + "' data-description='"+ data.itinerary.description +"' >View</a></li>"+
                                        "<li><a class='edit-modal ' data-id='" + data.itinerary.id + "' data-title='" + data.itinerary.title + "' data-description='"+ data.itinerary.description +"' >Edit</a></li>"+
                                        "<li><a class='delete-modal ' data-id='" + data.itinerary.id + "' data-title='" + data.itinerary.title + "' data-description='"+ data.itinerary.description +"' >Remove</a></li>"+
                                    "</ul>"+
                                "</div>"+
                            "</div>"+
                        "</td>"+
        ...
        $("#edit").click(function(e){
            ...
            $.ajax({
                ...
                success:function(data){
                    $('.itinerary' + data.itinerary.id).replaceWith("<tr class='tb-tnx-item itinerary" + data.itinerary.id + "'>"+
                    "<td class='tb-tnx-info'>"+
                        "<div class='tb-tnx-info'>"+
                            "<span class='title'>"+ data.itinerary.title + "</span>"+
                        "</div>"+
        ...
        //delete
        $("#del-itinerary").click(function(e){
            e.preventDefault();
            $.ajax({
                type:'POST',
                url:'deleteitinerary',
                ...
                success:function(data){
                    $('.itinerary' + data.itinerary).remove();
                },
            });
