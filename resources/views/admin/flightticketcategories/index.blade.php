                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between g-3">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Flight Ticket Categories</h3>
                                            <div class="nk-block-des text-soft">
                                                <p>You have total {{ $flightticketcategories->count() }} categories.</p>
                                            </div>
                                        ...
                                        <div class="nk-block-head-content">
                                            <ul class="nk-block-tools g-3">
                                                <li>
                                                    <div class="drodown">
                                                        <a href="{{ route('flightticketcategories.create') }}" class=" btn btn-icon btn-primary"><em class="icon ni ni-plus"></em></a>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div><!-- .nk-block-head-content -->
                                        ...
                                        <div class="card-inner-group">
                                            <div class="card-inner">
                                                <div class="card-title-group">
                                                    <div class="card-title">
                                                        <h5 class="title">All Flight Ticket Categories</h5>
                                                    </div>
                                            ...
                                            <div class="card-inner p-0">
                                                <table class="table table-tranx">
                                                    ...
                                                    <tbody>
                                                        @foreach ($flightticketcategories as $category)
                                                                    ...
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                                                            <ul class="link-list-plain">
                                                                                <li><a href="{{ route('flightticketcategories.edit',$category->id)}}">Edit</a></li>
                                                                                <li><a role="button" onclick="handleDelete({{$category->id}})">Remove</a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                </td>
...
@section('script')
    <script>
        function handleDelete(id){
            ...
            form.action='/flightticketcategories/'+id
